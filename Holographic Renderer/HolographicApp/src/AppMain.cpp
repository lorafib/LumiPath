    ...
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded +=
        ref new EventHandler<Gamepad^>(
            bind(&AppMain::OnGamepadAdded, this, _1, _2)
            );

    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved +=
        ref new EventHandler<Gamepad^>(
            bind(&AppMain::OnGamepadRemoved, this, _1, _2)
            );
...
void AppMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
    ...
    m_fibRenderer = std::make_unique<FibRenderer>(m_deviceResources);
...
HolographicFrame^ AppMain::Update()
{
    ...
    // Check for new input state since the last frame.
    // When a Pressed gesture is detected or mouse is clicked or gamepad is pressed, the sample hologram will be repositioned
...
void AppMain::OnDeviceLost()
{
    ...
    m_fibRenderer->ReleaseDeviceDependentResources();
}
...
{
    m_fibRenderer->CreateDeviceDependentResources();
}
...
void AppMain::OnGamepadAdded(Object^, Gamepad^ args)
{
...
void AppMain::OnGamepadRemoved(Object^, Gamepad^ args)
{
    m_gamepads.erase(
