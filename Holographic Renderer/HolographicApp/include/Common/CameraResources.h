...
namespace DX
{
    ...
    struct ViewProjectionConstantBuffer
    {
        ...
        DirectX::XMFLOAT4X4 inverse_view[2];
        DirectX::XMFLOAT4X4 inverse_projection[2];
    };
    ...
    public:
		...
		//Camer pos up to date after call to UpdateViewPojectionBuffer()
		const DirectX::XMFLOAT4*		GetCameraPositions()        const { return m_position;						}
